		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CardGame",
									"targetURL": "#comsmodcardgamecardgame-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodcardgamecardgame-display": {
								"semanticObject": "comsmodcardgamecardgame",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.cardgame.cardgame",
									"url": sap.ui.require.toUrl("com/smod/cardgame/cardgame")
								}
							}
						}
					}
